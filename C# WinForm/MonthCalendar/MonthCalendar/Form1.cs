...
namespace MonthCalendar
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            monthCalendar1.AddMonthlyBoldedDate(impDate);
        ...
        {
            string str1, str2;
            str1 = String.Format("開始:{0}", monthCalendar1.SelectionStart.ToShortDateString());
            str2 = String.Format("結束:{0}", monthCalendar1.SelectionEnd.ToShortDateString());
            label1.Text = str1;
            label2.Text = str2;
        }
    }
