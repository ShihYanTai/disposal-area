...
namespace Sample
{
    class Program
    {
        ...
        static void MutexSampleV2()
        {
            ...
            TransferHelper4 transferHelperA = new TransferHelper4(accA, accB, 1000);
            Thread t1 = new Thread(transferHelperA.Transfer)
            {
                Name = "t1"
            };
            TransferHelper4 transferHelperB = new TransferHelper4(accB, accA, 500);
            Thread t2 = new Thread(transferHelperB.Transfer)
            {
                Name = "t2"
            };
...
namespace OnLineBanking
{
    ...
    public class TransferHelper
    {
        ...
        public void Transfer()
        {
            ...
            Console.WriteLine($"Thread.CurrentThread.Name=={Thread.CurrentThread.Name}, is about tolock (_fromAccount), and _fromAccount.Id =={ _fromAccount.Id}");
            lock (_fromAccount)
            {
    ...
    */
    ...
    public class TransferHelper2
    {
        ...
        public void Transfer()
        {
            ...
            //***check the comment
            object _lockA = _fromAccount.Id < _toAccount.Id ? _fromAccount : _toAccount;
            object _lockB = _fromAccount.Id > _toAccount.Id ? _fromAccount : _toAccount;
    ...
    Beginning of Transfer, Thread.CurrentThread.Name==t2, _fromAccount.Id==2 ,_fromAccount.Balance==2000, _toAccount.Id==1, _toAccount.Balance==4000, _amount==500
    ...
    Beginning of Transfer, Thread.CurrentThread.Name==t1, _fromAccount.Id==1 ,_fromAccount.Balance==4000, _toAccount.Id==2, _toAccount.Balance==2000, _amount==1000
    ...
    End of Transfer, Thread.CurrentThread.Name==t2, _fromAccount.Id==2 , _fromAccount.Balance==1500,_toAccount.Id==1, _toAccount.Balance==4500, _amount==500
    ...
    End of Transfer, Thread.CurrentThread.Name==t1, _fromAccount.Id==1 , _fromAccount.Balance==3500,_toAccount.Id==2, _toAccount.Balance==2500, _amount==1000
