...
namespace Dinosaur_warrior
{
    public partial class Form1 : Form
    {
        ...
        Random rd;
        PictureBox[] picHero = new PictureBox[3];   // 英雄 3 張圖
        PictureBox[] picDinosaur = new PictureBox[3];// 噴火龍 3 張圖
        public Form1()
        {
            InitializeComponent();
        ...
        private void Form1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (fgKeyUp)                                    // 沒有按著按鍵
            {
                ...
                else if(heroState == 2 && dinosaurState == 0)
                {
                    dBlood -= 10;                           // 噴火龍失血
                }
                // ------------------------ 判斷輸贏 -------------------------------
